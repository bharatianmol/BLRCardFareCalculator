...
public class DailyCappedFareStrategy implements FareStrategy<Double>
{
	...
	public Double calculate(List<Commute> commuteDTOList, Tuple<Integer, Integer> farthestTravel)
	{
		...
		var cappedFare = FareConfig.getDailyCapFareMap().get(farthestTravel.getX()).get(farthestTravel.getX());
	...
	@Override
	public void setNextFareStrategy(com.zaprit.farecalculator.DailyCappedFareStrategy dailyStrategy) {
		// TODO Auto-generated method stub
		
	}

	public void setNextFareStrategy(WeeklyCappedFareStrategy weekStrategy) {
		// TODO Auto-generated method stub
